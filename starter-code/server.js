...
const app = express();
const conString = 'postgres://postgres:dada1@localhost:5432/kilovolt';// TODO: Don't forget to set your own conString
...
app.get('/articles', function(request, response) {
  ...
  client.query(`SELECT * FROM articles INNER JOIN authors ON articles.author_id=authors.author_id;`)  .then(function(result) {
